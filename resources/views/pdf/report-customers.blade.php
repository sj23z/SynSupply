...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Same shared per-customer block used by the Area/Sales-Rep PDFs —
       see resources/views/pdf/report-area.blade.php for the full
       rationale on the stmt- prefix and the scoped dir="rtl" wrapper. */
...
<body>
    <div class="header">
        ...
        <div class="doc-title">CUSTOMERS REPORT</div>
        <div class="clear"></div>
        <div class="meta">{{ $from }} &rarr; {{ $to }}</div>
    </div>
    ...
    <!-- HIERARCHY: every customer's full transaction statement -->
    @foreach ($customers as $c)
